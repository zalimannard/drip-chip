...
class AnimalTypeGetBadRequestTests {
    ...
    @ParameterizedTest
    @DisplayName("Негативный тест. Запрос некорректного typeId")
    @CsvSource(value = {
            "ADMIN, null",
            "ADMIN, 0",
            "ADMIN, -1",
    ...
    void invalidTypeId(AccountRole role, Long typeId) {
        ...
        ExceptionResponse response = AnimalTypeSteps.getExpectedBadRequest(typeId, auth);
