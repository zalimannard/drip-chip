...
class AnimalTypePostCreatedTests {
    ...
    void positiveTest(String role) {
        ...
        AnimalTypeResponseDto actual = AnimalTypeSteps.post(request, auth);
        AnimalTypeResponseDto expected = AnimalTypeFactory.createAnimalTypeResponse(actual.getId(), request);
